...
func (c *eventServiceClient) EmitEvent(ctx context.Context, in *EventMessage, opts ...grpc.CallOption) (*EventResponse, error) {
	out := new(EventResponse)
	err := c.cc.Invoke(ctx, EventService_EmitEvent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EventServiceServer interface {
	EmitEvent(context.Context, *EventMessage) (*EventResponse, error)
...
func _EventService_EmitEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).EmitEvent(ctx, req.(*EventMessage))
	}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kube_controller_event.EventService",
